                ...
                <CarouselItem key={orientador.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow h-full">
                    ...
                    <div className="space-y-2">
                      <h4 className="text-sm font-semibold text-gray-900 mb-2">Principais Qualificações:</h4>
                      <ul className="space-y-1">
                        {orientador.qualifications.slice(0, 3).map((qualification) => (
                          <li key={qualification} className="text-xs text-gray-600 flex items-start gap-2">
