      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Profissionais dedicados e experientes que formam a base da Liga Acadêmica em Neurologia Clínica.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Junte-se à Liga Acadêmica em Neurologia Clínica e faça parte de uma comunidade 
